...
class ConvertData
      ...
      group.map do |product|
        {
          ...
          "isbn"                  => product["isbn"],
          "amz_uk_url"            => "http://www.amazon.co.uk/s?k=#{isbn13(product)}",
          "amz_us_url"            => "http://www.amazon.com/s?k=#{isbn13(product)}",
          "amz_ca_url"            => "http://www.amazon.ca/s?k=#{isbn13(product)}",
          "amz_de_url"            => "http://www.amazon.de/s?k=#{isbn13(product)}",
          "amz_br_url"            => "http://www.amazon.com.br/s?k=#{isbn13(product)}",
          "amz_mx_url"            => "http://www.amazon.com.mx/s?k=#{isbn13(product)}",
          "amz_fr_url"            => "http://www.amazon.fr/s?k=#{isbn13(product)}",
          "amz_es_url"            => "http://www.amazon.es/s?k=#{isbn13(product)}",
          "amz_jp_url"            => "http://www.amazon.co.jp/s?k=#{isbn13(product)}",
          "amz_in_url"            => "http://www.amazon.in/s?k=#{isbn13(product)}",
          ...
          "waterstones_url"       => "https://www.waterstones.com/book/#{isbn13(product)}",
          "foyles_url"            => "http://www.foyles.co.uk/book/#{isbn13(product)}",
  ...
  def delete_old_files
    File.delete("_data/raw_data_with_headers.json") if File.exist?("_data/raw_data_with_headers.json")
